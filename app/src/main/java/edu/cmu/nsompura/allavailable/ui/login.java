...
import edu.cmu.nsompura.allavailable.exception.fix1to100;

public class login extends AppCompatActivity {
    EditText username, password;boolean flag=false;
    Button login,signup;
    static String usern;
    String user_name;
    String pass_word;
...
//    private GoogleMap map;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final customexception c = new customexception();
                    ...
                    Log.i("LKJSDFLK",username+"");
                        ...
                        if(usern.length() == 0) {
                            ...
                            if(passw.length() == 0){
                                ...
                                entered = true;
                                inputString="login:uname:"+usern+";pword:"+passw;
...
//                }});thread.start();
                if(entered == false){
                    Toast.makeText(getApplicationContext(),"Please Enter Username and Pasword",Toast.LENGTH_LONG).show();
                }
                Log.i("OUT","OUT");
//                while(flag==true)
//                {
